                    ...
                    <TooltipTrigger>
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                ...
                                >
                                    {user
                                        ? user.first_name?.split('', 1)[0]! +
                                          user.last_name?.split('', 1)[0]
                                        : 'EA'}
                                </Button>
                            </DropdownMenuTrigger>
                            <DropdownMenuContent
                            ...
                            >
                                <DropdownMenuGroup>
                                    ...
                                    <DropdownMenuItem className="my-2">
                                        <NavLink
                                            to={'/admin/settings'}
                                            className="flex gap-2 outline-1 p-1 rounded"
                            ...
                            >
                                ...
                                <DropdownMenuGroup>
                                    ...
                                    >
                                        ...
                                        <span
                                            className="ml-auto w-4 h-4 rounded-full border border-slate-400"
                                    ...
                                    >
                                        ...
                                        <span
                                            className="ml-auto w-4 h-4 rounded-full border border-pink-300"
                                    ...
                                    >
                                        ...
                                        <span
                                            className="ml-auto w-4 h-4 rounded-full border border-yellow-700"
                                            style={{ background: '#B39885' }}
                                        ></span>
                                    </DropdownMenuItem>
                                </DropdownMenuGroup>
                            </DropdownMenuContent>
