...
export default function Header() {
  ...
  const [showThemeDropdownMobile, setShowThemeDropdownMobile] = useState(false);
      ...
      {showChat && (
        <div className="fixed bottom-24 left-8 z-50 bg-white rounded-2xl shadow-2xl w-80 max-w-full p-4 flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto mb-2 max-h-48">
            {chatMessages.map(
              (msg: { user: string; text: string }, idx: number) => (
                <div
                  key={idx}
            ...
            <div className="absolute top-22 right-4 bg-[#eeeff1] text-[#1b1b1d] rounded-xl shadow-lg py-4 px-6 min-w-[220px] z-50">
              ...
              <div>
                <button
                  ...
                  onClick={() =>
                    setMobileSubMenu(
                      mobileSubMenu === "community" ? null : "community",
                    )
                  }
                >
                  Community
              ...
              <div>
                <button
                  ...
                  onClick={() =>
                    setMobileSubMenu(
                      mobileSubMenu === "collections" ? null : "collections",
                    )
                  }
                >
                  Collections
              ...
              <div className="flex gap-2 w-full mt-4 justify-center">
                ...
                <div className="relative group flex items-center">
                  <Button
                    ...
                    onClick={() =>
                      setShowThemeDropdownMobile((v: boolean) => !v)
                    }
                  >
                  ...
                  {showThemeDropdownMobile && (
                    <div className="absolute left-1/2 -translate-x-1/2 top-full mt-10 bg-white border rounded-xl shadow-lg py-2 px-2 min-w-[160px] z-50 flex flex-col gap-2">
                      <button
                        ...
                        onClick={() => {
                          setThemeName("rose");
                          setShowThemeDropdownMobile(false);
                        }}
                      >
                        <span style={{ fontSize: "1.2rem" }}>🌹</span> Rose
                      </button>
                      <button
                      ...
                      >
                        <span style={{ fontSize: "1.2rem" }}>☕</span> Coffee
                      </button>
                    </div>
                  )}
                </div>
                ...
                {showThemeDropdown && (
                  <div className="absolute left-[-6rem] top-full mt-2 bg-white border rounded-xl shadow-lg py-2 px-2 min-w-[180px] z-50 flex flex-col gap-2">
                    <button
                      ...
                      style={{
                        background:
                          themeName === "coffee" ? "#B39885" : "#F5F5E9",
                      }}
                      onClick={() => {
                        setThemeName("coffee");
                    ...
                    <button
                      ...
                      style={{
                        background:
                          themeName === "roseFlower" ? "#ffd6e0" : "#fff0f6",
                      }}
                      onClick={() => {
