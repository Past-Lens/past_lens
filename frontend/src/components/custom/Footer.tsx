        ...
        <>
            ...
            >
                ...
                <p className="max-w-xl mx-auto text-[#bdbdbd] mb-6">
                    Be part of the movement to preserve and celebrate cultural
                    heritage. Together, we can ensure our traditions live on for
                    future generations.
                </p>
                <motion.div className="flex items-center justify-center w-full gap-12">
                    <a href="/contribute">
                        <Button
                            size="lg"
                            variant="default"
                            className="bg-gradient-to-r from-slate-600 via-orange-500 to-slate-400 text-white cursor-pointer px-6 py-5 rounded-3xl text-xl shadow-2xl"
                        >
                            Contribute
                        </Button>
                    </a>
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                        <div className="flex flex-col gap-2 text-[#eeeff1] text-sm">
                            ...
                            <span className="flex items-center gap-2">
                                <Mail size={16} color="#eeeff1" />{' '}
                                info@pastlens.com
                            </span>
                            <span className="flex items-center gap-2">
                                <Phone size={16} color="#eeeff1" /> +254 700 000
                                000
                            </span>
                        </div>
                        <div className="flex flex-col gap-2 text-[#eeeff1] text-sm">
                            ...
                            <span className="flex items-center gap-2">
                                <MapPin size={16} color="#eeeff1" /> Nairobi,
                                Kenya
                            </span>
                        </div>
                    </div>
                    <div className="text-xs text-[#646464] mt-6 md:mt-0">
                        &copy; {new Date().getFullYear()} Past Lens. All rights
                        reserved.
                    </div>
                </div>
            </motion.footer>
