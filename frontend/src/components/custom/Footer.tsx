  ...
  className="py-16 px-4 text-center rounded-t-3xl relative"
      ...
      >
        ...
        <motion.div  className='flex items-center justify-center w-full gap-12'>
          <Button size="lg" variant="default" className="bg-[#eeeff1] text-[#1b1b1d] cursor-pointer p-4 hover:bg-amber-500 text-lg">Share your Story</Button>
          ...
          {/* Digital Clock */}
            <div className="flex gap-6 items-center justify-center px-6 py-2 rounded-xl bg-gradient-to-r from-[#232222] via-[#1b1b1d] to-[#232325] shadow border border-[#232325] min-w-[120px]">
                <span className="text-md font-semibold text-green-400 mt-1">online</span>
                <span className="text-2xl font-mono font-bold text-[#FFD700] tracking-widest">{hours}:{minutes}:{seconds} <span className='text-sm'>EAT</span></span>
            </div>
        </motion.div>
        ...
        >
          ...
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
            <motion.div whileHover={{ scale: 1.1, rotate: 10 }} className="flex items-center gap-3 mb-6 md:mb-0">
            <div className="w-12 h-12 rounded-full bg-[#eeeff1] flex items-center justify-center shadow">
                <Coffee size={28} color="#1b1b1d" />
            </div>
            <span className="text-2xl font-extrabold tracking-tight text-[#eeeff1]">Past Lens</span>
            </motion.div>
            <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="flex flex-col gap-2 text-[#eeeff1] text-sm">
                <span className="font-semibold">Contact</span>
                <span className="flex items-center gap-2"><Mail size={16} color="#eeeff1" /> info@pastlens.com</span>
                <span className="flex items-center gap-2"><Phone size={16} color="#eeeff1" /> +254 700 000 000</span>
            </div>
            <div className="flex flex-col gap-2 text-[#eeeff1] text-sm">
                <span className="font-semibold">Location</span>
                <span className="flex items-center gap-2"><MapPin size={16} color="#eeeff1" /> Nairobi, Kenya</span>
            </div>
            </div>
            <div className="text-xs text-[#646464] mt-6 md:mt-0">&copy; {new Date().getFullYear()} Past Lens. All rights reserved.</div>
        </div>
        </motion.footer>
    </>
  );
