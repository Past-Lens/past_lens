...
const pendingCount = contributionData.filter(c => c.status === "pending").length;
            ...
            <SidebarGroupContent>
              <SidebarMenu className="gap-3">
                {paths.map((path) => {
                  ...
                  const showBadge = path.title === "Contributions" && pendingCount > 0;
                  return (
                    <SidebarMenuItem
                      key={path.title}
                      className={cn(
                        ...
                        >
                          ...
                          {showBadge && (
                            <span
                              ...
                              style={{
                                background: themeColors.primary === "#b83260" ? "#b83260" : themeColors.primary,
                                color: "#fff",
                              }}
                            >
                              {pendingCount}
