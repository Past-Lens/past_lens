...
export default function Guide() {
    ...
    const nextStep = () => {
        const currentIndex = museumData.guideTour.steps.findIndex(
            (step) => step.id === currentStep.id
        );
        if (currentIndex < museumData.guideTour.steps.length - 1) {
            handleStepSelect(museumData.guideTour.steps[currentIndex + 1]);
        }
    };
                            ...
                            <div className="rounded-2xl overflow-hidden bg-black/20 backdrop-blur-sm border border-white/10">
                                <div className="aspect-video relative">
                                    <video
                                        ...
                                        poster={
                                            museumData.guideTour.welcomeVideo
                                        }
                                        playsInline
                                    />
                        ...
                        <div className="lg:w-1/3 bg-white/5 rounded-2xl backdrop-blur-sm border border-white/10">
                            ...
                            <div className="p-4 max-h-[60vh] overflow-y-auto">
                                <div className="space-y-3">
                                    {museumData.guideTour.steps.map(
                                        (step, index) => (
                                            <motion.div
                                                key={step.id}
