...
function getFeatureIcon(idx: number) {
    switch (idx) {
        case 0:
            return (
                <Coffee size={32} color="#1b1b1d" className="mx-auto mb-2" />
            );
        case 1:
            return (
                <BookOpen size={32} color="#1b1b1d" className="mx-auto mb-2" />
            );
        case 2:
        ...
        case 5:
            return (
                <Languages size={32} color="#1b1b1d" className="mx-auto mb-2" />
            );
        default:
            return null;
    }
