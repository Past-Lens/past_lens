...
function getFeatureIcon(idx: number) {
  switch (idx) {
    case 0:
      return <Coffee size={32} color="#1b1b1d" className="mx-auto mb-2" />;
    case 1:
      return <BookOpen size={32} color="#1b1b1d" className="mx-auto mb-2" />;
    case 2:
      return <Globe size={32} color="#1b1b1d" className="mx-auto mb-2" />;
    case 3:
      return <Star size={32} color="#1b1b1d" className="mx-auto mb-2" />;
    case 4:
      return <Mic size={32} color="#1b1b1d" className="mx-auto mb-2" />;
    case 5:
      return <Languages size={32} color="#1b1b1d" className="mx-auto mb-2" />;
    default:
      return null;
  }
}
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl w-full flex flex-col md:flex-row items-center gap-16">
          <motion.div
            ...
            className="w-80 h-80 rounded-[2.5rem] bg-[#ffffff] flex items-center justify-center shadow-2xl border-4 border-[#eeeff1] mb-8 md:mb-0"
          >
            <Coffee size={96} color="#1b1b1d" />
          </motion.div>
          <div className="flex-1 text-left">
            <h1 className="text-6xl font-extrabold mb-6 text-[#1b1b1d] leading-tight">
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="ml-2 text-lg font-semibold text-[#646464]">
            ...
            <motion.div whileHover={{ scale: 1.05 }}>
              <Button
                size="lg"
                variant="default"
                className="bg-[#1b1b1d] text-[#eeeff1] rounded-full px-10 py-4 text-xl font-bold shadow-lg cursor-pointer"
              >
                Get Started
              </Button>
            </motion.div>
      ...
      <motion.section
        ...
        transition={{ duration: 0.7 }}
        viewport={{ once: true }}
        className="py-16 px-4 bg-[#eeeff1]"
      >
        <h3 className="text-3xl font-bold text-center mb-12 text-[#1b1b1d]">
          ...
          {content.features.map((feature, idx) => (
            ...
            >
              <Card className="text-center bg-[#f3f4f5] border-none shadow-lg">
                <CardHeader>
                  {getFeatureIcon(idx)}
                  <CardTitle className="text-[#1b1b1d] mb-2">
                    {feature.title}
                  </CardTitle>
      ...
      >
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <motion.div
            whileHover={{ scale: 1.05, rotate: -8 }}
            className="w-64 h-64 rounded-3xl bg-[#646464] flex items-center justify-center shadow-lg mb-8 md:mb-0"
          >
            <BookOpen size={64} color="#eeeff1" />
          </motion.div>
          <div className="flex-1">
            <h3 className="text-3xl font-bold mb-4 text-[#1b1b1d]">
      ...
      <motion.section
        ...
        style={{
          background:
            "linear-gradient(120deg, #ffe5d0 0%, #ffd6e0 60%, #e0e7ef 100%)",
        }}
      >
        <motion.h3
          initial={{ opacity: 0, y: 40 }}
          ...
          viewport={{ once: true }}
          className="text-3xl font-bold text-center mb-12 text-[#1b1b1d]"
        >
          Meet Past Lens Team
        </motion.h3>
        <div className="relative max-w-6xl mx-auto">
          {/* Left Arrow */}
          <button className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-[#1b1b1d] text-[#eeeff1] rounded-full p-3 shadow-lg hover:scale-110 transition">
            <svg
              width="24"
              height="24"
              fill="none"
          ...
          {/* Right Arrow */}
          <button className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-[#1b1b1d] text-[#eeeff1] rounded-full p-3 shadow-lg hover:scale-110 transition">
            <svg
              width="24"
              height="24"
              fill="none"
              ...
              >
                ...
                >
                  <Avatar className="w-24 h-24">
                    <AvatarFallback className="text-gray-900 font-bold text-3xl">
                      {member.name[0]}
                    </AvatarFallback>
                  </Avatar>
                </motion.div>
                ...
                >
                  <CardTitle className="text-[#1b1b1d] text-xl font-bold mb-1">
                    {member.name}
                  </CardTitle>
                  <CardDescription className="text-[#646464] font-semibold mb-2">
                    {member.role}
                  </CardDescription>
                  <CardDescription className="text-[#646464] text-sm mb-2">
                    {member.bio}
                  </CardDescription>
                </motion.div>
              </motion.div>
      ...
      <motion.section
        ...
        style={{
          background:
            "linear-gradient(120deg, #f3f4f5 0%, #d1d5db 40%, #6b7280 100%)",
        }}
      >
        <h3 className="text-2xl font-bold mb-4 text-[#1b1b1d]">
          Join Us in Preserving Culture
        </h3>
        <p className="max-w-xl mx-auto text-[#646464] mb-6">
        ...
        >
          <Button
            size="lg"
            variant="default"
            className="bg-[#1b1b1d] text-[#eeeff1] cursor-pointer"
          >
            Contact Us
          </Button>
        </motion.div>
      ...
      <div className="fixed top-30 right-8 z-40">
        ...
        >
          <Bot size={28} />
          {showTooltip && (
            <span className="absolute left-1/2 -translate-x-1/2 top-full mt-2 px-3 py-1 bg-black text-white text-xs rounded shadow-lg whitespace-nowrap">
        ...
        {showChat && (
          <div className="absolute left-0 bottom-12 w-80 bg-white rounded-xl shadow-2xl p-4 flex flex-col gap-2 border border-orange-200 animate-fade-in">
            <div className="flex justify-between items-center mb-2">
              ...
              <button
                className="text-gray-500 hover:text-orange-700 text-lg font-bold"
                onClick={() => setShowChat(false)}
              >
                ×
              </button>
            </div>
            <div className="flex-1 min-h-[120px] bg-orange-50 rounded p-2 mb-2 text-sm text-gray-700">
            ...
            >
              <input
                ...
                className="border border-orange-200 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-orange-400 w-full pr-10"
              />
              <button
                type="submit"
                className="absolute right-2 top-1/2 -translate-y-1/2 text-orange-600 hover:text-orange-800 p-1 cursor-pointer"
              >
                <svg
                  width="22"
                  height="22"
