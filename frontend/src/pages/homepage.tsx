  ...
  return (
    <>
      ...
      <section className="py-16 px-4 max-w-3xl mx-auto relative flex">
        ...
        <div
          className="hidden md:flex flex-col items-center absolute left-[-32px] top-[80px]"
        ...
        >
          <div className="w-1 h-full rounded-full bg-gradient-to-b from-orange-400 via-pink-500 to-red-500 shadow-lg relative">
            {content.faq.map((_, idx) => (
              <span
                key={idx}
                style={{ top: `${(idx + 0.5) * 64}px` }}
                className="absolute left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-white border-2 border-orange-400 shadow"
              />
            ))}
          </div>
        </div>
        ...
        <div className="flex-1">
          <h3 className="text-3xl font-bold text-center mb-10 text-[#1b1b1d]">
          ...
          <div className="flex flex-col gap-6">
            {content.faq.map((item, idx) => (
              <div
                key={idx}
                className="border border-orange-200 rounded-xl bg-white shadow"
              >
                <button
                ...
                >
                  ...
                  <span
                    className={`transition-transform duration-200 ${openFaq === idx ? "rotate-90" : ""}`}
                  >
                    <ChevronRightIcon />
                  </span>
                </button>
      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <button
            onClick={() =>
              document
                .getElementById("team-scroll")
                ?.scrollBy({ left: -320, behavior: "smooth" })
            }
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-[#1b1b1d] text-[#eeeff1] rounded-full p-3 shadow-lg hover:scale-110 transition"
          >
            <svg
              width="24"
              height="24"
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-[#1b1b1d] text-[#eeeff1] rounded-full p-3 shadow-lg hover:scale-110 transition"
          >
            <svg
              width="24"
              height="24"
